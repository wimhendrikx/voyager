...
return [
    ...
    'relationship'              => [
        ...
        'has_one'              => 'Heeft één',
        'has_many'             => 'Heeft meerdere',
        'belongs_to'           => 'Behoort tot',
        'belongs_to_many'      => 'Behoort tot meerdere',
        'which_column_from'    => 'Vanaf welke kolom',
        'is_used_to_reference' => 'is gerelateerd tot',
        'pivot_table'          => 'Keertabel',
        'selection_details'    => 'Selectie Details',
        'display_the'          => 'Toon de',
        'store_the'            => 'Sla op',
        'allow_tagging'        => 'Tagging toestaan',
        'easy_there'           => 'Easy there Captain',
        'before_create'        => 'Vooraleer je een nieuwe relatie aanmaakt, moet je eerst de BREAD maken. <br> Ga vervolgens terug naar Bread Wijzigen om een nieuwe relatie toe te voegen.',
        'cancel'               => 'Annuleren',
        'add_new'              => 'Nieuwe relatie toevoegen',
        'open'                 => 'Openen',
        'close'                => 'Sluiten',
        'relationship_details' => 'Details relatie',
        'browse'               => 'Zoeken',
        'read'                 => 'Lezen',
        'edit'                 => 'Wijzigen',
        'add'                  => 'Toevoegen',
        'delete'               => 'Verwijderen',
        'create'               => 'Maak een relatie aan',
